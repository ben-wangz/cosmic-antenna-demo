...
public class MultiplyWithCoefficient
  ...
  public void process(
    ...
    try (Mat dataRealMat = new Mat(antennaSize, timeSampleUnitSize, CV_64FC1);
      ...
      LOGGER.info(
          "data imaginary matrix shape is ({},{})",
